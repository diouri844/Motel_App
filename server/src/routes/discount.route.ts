...
export class DiscountRoute extends DiscountRouteAbstract {
    ...
    protected initializeRoutes(): void {
        ...
        this.router.post(
            this.router + "/apply", this.discountController.applyDiscount.bind(this.discountController));
        ...
        this.router.get(
            this.path + "/check/:disouncId", this.discountController.checkDiscount.bind(this.discountController));
        this.router.delete(
